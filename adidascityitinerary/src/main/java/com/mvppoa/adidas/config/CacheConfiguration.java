...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("adidascityitinerary");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("adidascityitinerary");
        ...
        config.getMapConfigs().put("com.mvppoa.adidas.domain.*", initializeDomainMapConfig(jHipsterProperties));
